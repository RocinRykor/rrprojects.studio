...
class ProjectForm(FlaskForm):
    ...
    repo_link_description = StringField("Repository Description", validators=[InputRequired(), Length(max=256)], default="Check out the project on GitHub!")
    live_link = StringField("Live URL", validators=[InputRequired(), Length(max=256)])
    live_link_description = StringField("Repository Description", validators=[InputRequired(), Length(max=256)], default="View the live version here!")
